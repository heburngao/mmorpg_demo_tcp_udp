...
namespace ghbc.Net
{
	...
	/// </summary>
	public class CmbineBuffer_Dynamic
	{
		...
		/// 残包 ，缓存带
		/// </summary>
		private   byte[] tooShortPackage;
		//　短包
		/// <summary>
		/// 读取缓存 整包
		/// </summary>
		public   byte[] CombinedBuff;
		//　最终的包
		...
		public   int GetRealReadBuf (int byteSize)
		{
			bufIndex = 0;
		...
		public   byte[] GeUsefulBuff (int fullSize)
		{
		...
		public   void TooShortReceive (int bytesRead)
		{
		...
		public   int GetMsgSize (int startIndex)
		{
